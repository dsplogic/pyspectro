...
import threading
import time
from atom.api import Atom, Int, Enum, Value, Typed, Bool, observe, Float, Signal, Str, FloatRange
    ...
    def _core_state_change_handler(self, change):
        ...
        if newval == "connecting":
            ...
            if change["oldvalue"] == "connecting":
                ...
                self.refresh_timer = TimedProcessor(
                    interval=self.refresh_interval, task=deferred_call, args=(self.display_next_measurement,), kwargs={}
                )
