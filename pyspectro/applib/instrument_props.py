...
def get_temperature_properties(device):
    ...
    result["temp_adc_c"] = device.instrument.InstrumentInfo.MonitoringValues[
        "MezzFrontEndA_AdcTemperature"
    ].CurrentValue
    result["temp_adc_c_max"] = device.instrument.InstrumentInfo.MonitoringValues[
        "MezzFrontEndA_AdcTemperature"
    ].LimitHigh  #: 125
    ...
    result["temp_dpu_c_max"] = device.instrument.InstrumentInfo.MonitoringValues[
        "Dpu_Temperature"
    ].LimitHigh  #: 100 deg c
...
def get_instrument_properties(device):
    ...
    result[
        "Instrument_FirmwareRevision"
    ] = (
        device.instrument.Identity.InstrumentFirmwareRevision
    )  #: CTRL FPGA 1.0.352.54534, DPU FPGA 0.2.16.6M, FE CPLD 23/10
    ...
    result[
        "Driver_IoResourceDescriptor"
    ] = device.instrument.DriverOperation.IoResourceDescriptor  #: PXI4::4-0.0::INSTR
