...
class PySpectroCore(CommandThread):
    ...
    def __init__(self, app, *args, **kwargs):
        ...
        self._hb = TimedProcessor(interval=1.0, task=self._heartbeat_event.set, args=(), kwargs={})
            ...
            if self._state == "disconnected":
                ...
                if cmd:
                    if cmd == "connect":
                        ...
                        logger.warning(
                            "{0} ignored command {1} in state {2}".format(self.__class__.__name__, cmd, self._state)
                        )
